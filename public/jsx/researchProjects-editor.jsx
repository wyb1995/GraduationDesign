...
let researchDirections = require('../../file/researchProjects');
import superagent from 'superagent';
require('../css/editor.css');

class ResearchProjectsEditor extends React.Component {
  ...
  submit() {
    ...
    superagent.post('/api/researchProjects')
      .send({content})
      .end((err, res)=> {
        alert('saved!');
      })
...
export default ResearchProjectsEditor;
